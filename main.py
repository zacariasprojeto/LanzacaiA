...
# --- Função Principal que o Google Cloud irá chamar ---
def run_cron_job(request):
    ...
    try:
        ...
        # A API Key da Odds API também é carregada do ambiente
        ...
        return f"Erro Crítico ao inicializar Supabase: {e}", 500 # Retorna erro HTTP 500
    
    # --- Continuação da Lógica de Negócios (Funções Auxiliares) ---
        ...
        try:
            ...
            for jogo in dados_api:
                ...
                for odd_outcome in odds_source:
                    ...
                    # Lógica de IA Simplificada (Placeholder)
                    probabilidade = 0.50
    ...
    print("\n--- Processo concluído ---")
    return "Execução do Cron Job concluída com sucesso.", 200 # Retorna sucesso HTTP 200
